...
//          (Refer question number 5 for nicer approach)

//        List<Integer> list2 = Arrays.asList(2, 34, 45, 23, 55, 243, 319);
//
//        List<Integer> collect = list2.stream()
//                .map(e -> String.valueOf(e)) //Converting each Integer to String => 34 -> "34"
...
//        Understanding Working of Add Function .add():~
//        it returns false :- If this set already contains the element, the call leaves the set unchanged and returns false.
//        it returns true :- If element was not present and set add the value successfully.
...
//
//        List<Integer> evens = list.stream().filter(n -> n % 2 == 0).sorted((a, b) -> b - a).toList();
//        List<Integer> odds = list.stream().filter(n -> n % 2 != 0).sorted((a, b) -> b - a).toList();
//
//        List<Integer> collect = Stream.concat(evens.stream(), odds.stream()).toList();
//        System.out.println(collect);
...
//                .ifPresent(System.out::println);
        //===============================================================================================================
        //Q.16)Implement a method to partition a list into 2 groups based on a predicate.
